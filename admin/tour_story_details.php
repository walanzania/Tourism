<?php 
	...
	if (isset($_GET['publish'])) {
		...
		if ($updStatus) {
			echo "<script>alert('Updated Successfully ...');window.location='tour_story_details?categ_unit=$slug'</script>";
		}else{
	...
	if (isset($_GET['delete'])) {
		...
		if ($deleteStory) {
			echo "<script>window.location='all_tour_story';alert('Story Deleted');</script>";
		}else{
